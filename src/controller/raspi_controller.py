...
class RaspiController:
    ...
    def turn_searchled_off(position):
        leds = LedDataService
    ...
    def turn_completionled_on(position):
        leds = LedDataService
        led_list = leds.get_leds()
        print("ON")
    ...
    def turn_completionled_off(position):
        leds = LedDataService
        led_list: list = leds.get_leds()
        print("Off")
        l = led_list[position].completion_led
...
d = RaspiController
d.turn_seachled_on(0)
sleep(2)
d.turn_searchled_off(0)
